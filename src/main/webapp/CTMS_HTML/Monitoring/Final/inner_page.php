...
<script src="js/commonutil.js" charset="UTF-8" type="text/javascript"></script></head>
		...
		<nav id="sliding-nav"><span class="header-1"><a href="#" style="color:#FFF;">Clinical Monitoring</a></span>
			<div id="menu-expand">
				<a href="#" class="closed" ><span>+</span></a>			</div>
		  <aside id="sidebar">
  <a href="../index.php" class="ir">Clinical Monitoring</a>
  	<nav id="primary">
		<ul>
...
<section id="subnav">
    ...
    position: relative;
    top: 28px;">
    <a href="#" class="menu-item dropdown-trigger" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Portfolio View</a>
...
<div class="main-image"><img src="images/main-img.png" border="0" usemap="#Map">
  <map name="Map">
    <area shape="rect" coords="18,51,91,73" href="trial-risk.php">
    <area shape="rect" coords="18,81,92,101" href="trial-risk.php">
    <area shape="rect" coords="18,110,91,130" href="trial-risk.php">
    <area shape="rect" coords="18,139,90,160" href="trial-risk.php">
    <area shape="rect" coords="17,167,93,190" href="trial-risk.php">
    <area shape="rect" coords="17,197,89,216" href="trial-risk.php">
    <area shape="rect" coords="17,224,89,246" href="trial-risk.php">
    <area shape="rect" coords="17,256,93,276" href="trial-risk.php">
  </map>
</div>
