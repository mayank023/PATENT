...
Page </TITLE>
    ...
    <script type="text/javascript" src="patient-json-grid-servlet.js"></script>
...
<DIV class="page">
	<TABLE width="1135px" align="left" id="MainContent_tblSubjectInfo"  frame="border">
	  ...
	  <TR>
		<TD align="left" class="accordionHeaderSelected">
			<DIV id="MainContent_SubjectInfo_Panelctrl" style="margin-left: 5px; float: left; white-space: nowrap;">
				<SPAN id="MainContent_SubjectInfo_LBLSubjectInfo" style="font-size: large;">PatientList for <%= trialId %> - <%= siteId %></SPAN>			 
			</DIV>
	  ...
	  <TR>
		<TD align="Right" >
			<input type="button" value="Configure Trial" onclick="callConfigureTrial()">
		</TD>
		</TR>
